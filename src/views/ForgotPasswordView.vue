...
<template>
    <AuthLayout>
        <!--  Титул + быстрый вход  -->
          ...
          <!--  Форма  -->
          <form id="forgetPasswordForm" class="auth__form">
            <div class="auth__form-input auth__form-input--email form-floating mb-5">
              <input type="email" class="form-control" id="forgetPasswordEmailInput" placeholder="Адрес электронной почты" required>
