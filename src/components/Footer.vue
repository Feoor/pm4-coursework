...
<template>
  ...
  <footer class="footer">
    <div class="container-sm">
      <div class="footer__wrapper row flex-column g-0">

        <!-- Logo -->
        <div class="footer__top col-12 d-flex justify-content-between align-items-sm-center">
          ...
          <div class="footer__nav">
            <ul class="footer__list menu list-reset">
              <li class="menu__item"><router-link to="/">Главная</router-link></li>
